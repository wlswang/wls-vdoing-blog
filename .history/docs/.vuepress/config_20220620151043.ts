...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  // base: '/wls-vdoing-blog/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyrightInfo:
        'wlswang | <a href="https://github.com/wlswang/wls-vdoing-blog/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签或换行标签</br>
    },
  ...
  head: [
    ['link', { rel: 'icon', href: '/img/favico.ico' }], //favicons，资源放在public文件夹
    [
      'meta',
      {
        name: 'keywords',
    ...
    ['meta', { name: 'baidu-site-verification', content: 'code-Zi4RAsaYd2' }], // 百度统计的站长验证（你可以去掉）
