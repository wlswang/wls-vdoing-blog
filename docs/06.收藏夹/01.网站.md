...
<p align="center">
<img src="https://open.weixin.qq.com/qr/code?username=gh_bdb377209fea" width="200">
</p>

::: center
关注公众号，回复`前端资源`，获取前端学习资料
:::
...
- [stack overflow](https://stackoverflow.com/) 一个回答技术问题的网站
- [InfoQ](https://www.infoq.cn/topic/Front-end) 促进软件开发及相关领域知识与创新的传播
- [js 技巧](https://www.jstips.co/) 每天推送一个 js 技巧
- [Node.js 中文社区](https://cnodejs.org/) node 专业中文社区
- [W3cplus](https://www.w3cplus.com/) 推广国内前端行业的技术博客
